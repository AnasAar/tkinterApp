...
#class dseWindow pour la gestion de la filiere data and softwar engineering
class dseWindow:
    ...
    def __init__(self):
        ...
        self.window2.title("Data & Software Engineering (DSE )")
        self.window2.iconbitmap('insea.ico')
        self.txt = Label(self.window2, text="Filiére Data & Software Engineering (DSE ) :", font=('Arial Bold', 13),bg='green', fg='white')
    ...
    def show(self):
        mycursor = db.cursor()
        mycursor.execute(""" SELECT * FROM etudiant WHERE filiereid= 1""")
