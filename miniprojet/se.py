...
#class dsWindow pour la gestion de la filiere Statistique - Economie appliquée
class seWindow:
    ...
    def __init__(self):
        ...
        self.window2.title("Statistique - Economie appliquée")
        self.window2.iconbitmap('insea.ico')
        self.txt = Label(self.window2, text="Filiére Statistique - Economie appliquée :", font=('Arial Bold', 13),bg='green', fg='white')
    ...
    def show(self):
        mycursor = db.cursor()
        mycursor.execute(""" SELECT * FROM etudiant WHERE filiereid= 5""")
