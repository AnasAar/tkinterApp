...
#class dsWindow pour la gestion de la filiere data science
class dsWindow:
    ...
    def __init__(self):
        ...
        self.window2.title("Data Science")
        self.window2.iconbitmap('insea.ico')
        self.txt = Label(self.window2, text="Filiére Data Science :", font=('Arial Bold', 13),bg='green', fg='white')
    ...
    def show(self):
        mycursor = db.cursor()
        mycursor.execute(""" SELECT * FROM etudiant WHERE filiereid= 2""")
