...
#class dsWindow pour la gestion de la filiere Statistique - Démographie
class sdWindow:
    ...
    def __init__(self):
        ...
        self.window2.title("Statistique - Démographie")
        self.window2.iconbitmap('insea.ico')
        self.txt = Label(self.window2, text="Filiére Statistique - Démographie :", font=('Arial Bold', 13),bg='green', fg='white')
    ...
    def show(self):
        mycursor = db.cursor()
        mycursor.execute(""" SELECT * FROM etudiant WHERE filiereid= 6""")
