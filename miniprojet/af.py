...
#class afWindow pour la gestion de la filiere actuariat finance
class afWindow:
    ...
    def __init__(self):
        ...
        self.window2.title("Actuariat- Finance")
        self.window2.iconbitmap('insea.ico')
        self.txt = Label(self.window2, text="Filiére Actuariat- Finance :", font=('Arial Bold', 13),bg='green', fg='white')
    ...
    def show(self):
        mycursor = db.cursor()
        mycursor.execute(""" SELECT * FROM etudiant WHERE filiereid= 3""")
